  ...
  Failure mapDioExceptionToFailure(DioException e, StackTrace stackTrace) {
    switch (e.type) {
      ...
      case DioExceptionType.connectionError:
        return Failure(
          message:
              "Connection error with API server. Please try again later"
                  .hardcoded,
          exception: e,
          stackTrace: stackTrace,
        );
...
String _getErrorMessageForStatusCode(int? statusCode) {
  switch (statusCode) {
    ...
    case 422:
      return "Invalid user. Please try again later".hardcoded;
    case 404:
      return "Not found. Please try again later".hardcoded;
    case 405:
      return "Method not allowed. Please try again later".hardcoded;
    case 500:
      return "Internal server error. Please try again later".hardcoded;
    case 501:
      return "Not implemented. Please try again later".hardcoded;
    case 503:
