...
import 'package:fluttercleanarchitecture/gen/assets.gen.dart';
    ...
    return Column(
      children: [
        ...
        Row(
          ...
          children: [
            IconButton(
              icon: Assets.images.google.svg(width: 32, height: 32),
              onPressed: () {
                // Handle Google login
              },
            ),
            ...
            IconButton(
              icon: Assets.images.apple.svg(width: 32, height: 32),
              onPressed: () {
                // Handle Apple login
              },
            ),
