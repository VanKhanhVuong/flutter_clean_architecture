...
part of 'delete_flashcard_api.dart';
...
class _DeleteFlashcardApi implements DeleteFlashcardApi {
  _DeleteFlashcardApi(this._dio, {this.baseUrl, this.errorLogger});
