...
part of 'resend_reset_code_api.dart';
...
class _ResendResetCodeApi implements ResendResetCodeApi {
  _ResendResetCodeApi(this._dio, {this.baseUrl, this.errorLogger});
