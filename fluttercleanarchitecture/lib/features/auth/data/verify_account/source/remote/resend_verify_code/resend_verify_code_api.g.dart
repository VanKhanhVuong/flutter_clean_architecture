...
part of 'resend_verify_code_api.dart';
...
class _ResendVerifyCodeApi implements ResendVerifyCodeApi {
  _ResendVerifyCodeApi(this._dio, {this.baseUrl, this.errorLogger});
